...
public class acerlaptop extends AppCompatActivity {
    private DrawerLayout drawerLayout;//滑動選單

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_acerlaptop);
        ...
        btn_asus.setOnClickListener(new View.OnClickListener() { //點擊後執行跳頁的指令
            ...
            public void onClick(View view) {
                ...
                intent.setClass(acerlaptop.this, AcerAspire5A51543R19L.class);
        ...
        btn_laptop.setOnClickListener(new View.OnClickListener() { //點擊後執行跳頁的指令
            ...
            public void onClick(View view) {
                Intent intent = new Intent();
                intent.setClass(acerlaptop.this, AcerA51545R2B5.class);
                startActivity(intent);
            }
        });
        btn_open.setOnClickListener(v -> {
            ...
            btn_phone.setOnClickListener(new View.OnClickListener() { //點擊後執行跳頁的指令
                ...
                public void onClick(View view) {
                    Intent intent = new Intent();
                    intent.setClass(acerlaptop.this, phoneActivity.class);
                    startActivity(intent);
                }
            ...
            btn_home.setOnClickListener(new View.OnClickListener() { //點擊後執行跳頁的指令
                ...
                public void onClick(View view) {
                    Intent intent = new Intent();
                    intent.setClass(acerlaptop.this, MainActivity.class);
                    startActivity(intent);
                }
