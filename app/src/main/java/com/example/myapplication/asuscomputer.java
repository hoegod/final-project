...
public class asuscomputer extends AppCompatActivity {
    private DrawerLayout drawerLayout;//滑動選單

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_asuscomputer);
        ...
        btn_asus.setOnClickListener(new View.OnClickListener() { //點擊後執行跳頁的指令
            ...
            public void onClick(View view) {
                ...
                intent.setClass(asuscomputer.this, s500sa.class);
        ...
        btn_laptop.setOnClickListener(new View.OnClickListener() { //點擊後執行跳頁的指令
            ...
            public void onClick(View view) {
                Intent intent = new Intent();
                intent.setClass(asuscomputer.this, s700ta.class);
                startActivity(intent);
            }
        });
        btn_open.setOnClickListener(v -> {
            ...
            btn_phone.setOnClickListener(new View.OnClickListener() { //點擊後執行跳頁的指令
                ...
                public void onClick(View view) {
                    Intent intent = new Intent();
                    intent.setClass(asuscomputer.this, phoneActivity.class);
                    startActivity(intent);
                }
            ...
            btn_home.setOnClickListener(new View.OnClickListener() { //點擊後執行跳頁的指令
                ...
                public void onClick(View view) {
                    Intent intent = new Intent();
                    intent.setClass(asuscomputer.this, MainActivity.class);
                    startActivity(intent);
                }
