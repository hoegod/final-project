    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_asus.setOnClickListener(new View.OnClickListener() { //點擊後執行跳頁的指令
            ...
            public void onClick(View view) {
                ...
                intent.setClass(apple.this, applecomputer.class);
        ...
        btn_laptop.setOnClickListener(new View.OnClickListener() { //點擊後執行跳頁的指令
            ...
            public void onClick(View view) {
                Intent intent = new Intent();
                intent.setClass(apple.this, aaplelaptop.class);
                startActivity(intent);
            }
        });
        btn_pad.setOnClickListener(new View.OnClickListener() { //點擊後執行跳頁的指令
            ...
            public void onClick(View view) {
                Intent intent = new Intent();
                intent.setClass(apple.this, applepad.class);
                startActivity(intent);
            }
        });
        btn_open.setOnClickListener(v -> {
            ...
            btn_phone.setOnClickListener(new View.OnClickListener() { //點擊後執行跳頁的指令
                ...
                public void onClick(View view) {
                    Intent intent = new Intent();
                    intent.setClass(apple.this, phoneActivity.class);
                    startActivity(intent);
                }
            ...
            btn_home.setOnClickListener(new View.OnClickListener() { //點擊後執行跳頁的指令
                ...
                public void onClick(View view) {
                    Intent intent = new Intent();
                    intent.setClass(apple.this, MainActivity.class);
                    startActivity(intent);
                }
